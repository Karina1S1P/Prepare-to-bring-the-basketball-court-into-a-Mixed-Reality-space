...
with open('/home/azureuser/cloudfiles/code/Users/kkrotkiewicz/Prepare to bring the basketball court into a Mixed Reality space/ConvertCSV/game_stats.csv') as csv_file:
